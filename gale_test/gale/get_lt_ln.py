    ...
    if assignment:
      ...
      for vehicle_nbr in range(num_vehicles):
        ...
        while not routing.IsEnd(index):
          ...
          cum_weight.append(load_var)
          cum_volume.append(load_var)
        ...
        print plan_output
        import pandas
        df = pandas.DataFrame(data={"Truck1": truck, "Address": address1,"distance":distances,"cum_distance":cum_distance,"weight":weight,"cum_weight": cum_weight, "volume":volume1,"cum_vol":cum_volume,"time_range":time_range})
        df.to_csv('result_route_18_04.csv', index=False)
        print "\n"
